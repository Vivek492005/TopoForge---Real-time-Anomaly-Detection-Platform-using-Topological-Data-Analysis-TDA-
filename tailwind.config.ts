    ...
    extend: {
      ...
      colors: {
        ...
        topo: {
          ...
          h1: "hsl(var(--topo-h1))",
          h2: "hsl(var(--topo-h2))",
          birth: "hsl(var(--topo-birth))",
          death: "hsl(var(--topo-death))",
        },
        sidebar: {
      ...
      boxShadow: {
        ...
        "glow-anomaly": "var(--shadow-glow-anomaly)",
      ...
      animation: {
        ...
        "topology-morph": "topology-morph 20s ease-in-out infinite",
      ...
      backgroundImage: {
        ...
        "gradient-mesh": "radial-gradient(ellipse at 50% 0%, hsl(var(--primary) / 0.15), transparent 50%)",
